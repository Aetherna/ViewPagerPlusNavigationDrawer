 ...
 */
public class BlueDataFragment extends Fragment {
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.blue_data_fragment, container, false);

        click = (Button) viewGroup.findViewById(R.id.button);
        click.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
                ((OttoApplication) getActivity().getApplication()).getTransactionsModel().handleClick(ETransactionType.BLUE);
            }
        });
